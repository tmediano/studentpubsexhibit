...
- For this project, please follow the convention of using `pub-` + your initials + the number of record created by you.
- Examples:
    - `pub-tm01` 
    - `pub-tm02`
...
- *required*
- Please use the Digital Commons URL of the issue you'd like to add to the exhibit.
- Examples: 
    - link to image: `https://digitalcommons.risd.edu/cgi/viewcontent.cgi?article=1136&context=studentnewspapers`
...
- Example value: `Cover page of the fifth issue of the *Penny Dreadful Commission* with illustrations clearly influenced by famous artist.`
